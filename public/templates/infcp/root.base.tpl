...
<link rel="alternate" type="application/rss+xml" title="News feed" href="/news/rss/" />
    ...
    <link href="{$config.template_url}assets/css/bootstrap3-typeahead/style.css" rel="stylesheet" type="text/css" />
...
{if $user.level >= 50}
    <script type="text/javascript">
        ...
        site.scripts.push('/vendor/tinymce/tinymce.jquery.min');
...
{capture name='jsResources'}
    <script type="text/javascript" src="{$config.site_url}vendor/jquery/dist/jquery.js"></script>
