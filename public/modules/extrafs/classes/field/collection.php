 ...
 */
class extrafs_field_collection extends abs_collection {
    ...
    protected function alloc_before(&$class, &$config, &$data, &$verified) {
        ...
        if (!empty($data['type'])) {
            ...
            if (!class_exists($class, 0)) {
                require('modules/extrafs/classes/field/ctl/' . $type . '.php');
            }
        }
    }
 ...
 * Field item
 */
class extrafs_field_item extends abs_collection_item {
