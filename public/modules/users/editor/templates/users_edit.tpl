...
<div class="form">
    ...
    <div class="form-block">
        ...
        <input type="text" name="login" size="40" value="{$return.form.login}" validate="{ldelim}required:1{rdelim}"/>
    </div> 
    ...
    <div class="form-block">
        ...
        <input type="text" name="nick" size="40" value="{$return.form.nick}" validate="{ldelim}required:1{rdelim}"/>
    </div>  
     ...
     <div class="form-block">
        ...
        <div>
            ...
            {foreach item=list from=$tpl_user_group}   
                <option value="{$list.id}" {if $list.id == $return.form.gid}selected="selected"{/if}>{$list.title}</option>
            {/foreach}
            </select>                 
        </div>  
    </div>        
