...
abstract class acl_collection_abstract extends abs_collection {
    ...
    */
    ...
    function construct_after() {        
        if (!isset($this->_actions)) {
            $this->_actions = require "modules/users/classes/acl/actions.php";
        }                           
    }    
...
abstract class acl_item_abstract extends abs_collection_item {
